...
$(function () {
    ...
    checkItem.onclick = function () {
        ...
        if( parseInt(adult) < 3){
            document.getElementById("totalPrice").innerText = 2380 * parseInt(planDays)  + '元';
        }else{
            document.getElementById("totalPrice").innerText = 2380 * parseInt(planDays) + 500 * parseInt(planDays) + '元';
        }
    }
