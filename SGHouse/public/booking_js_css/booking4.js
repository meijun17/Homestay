...
$(function () {
    ...
    checkItem.onclick = function () {
        ...
        if( parseInt(adult) < 2){
            document.getElementById("totalPrice").innerText = 980 * parseInt(planDays)  + '元';
        }else{
            document.getElementById("totalPrice").innerText = 980 * parseInt(planDays) + 500 * parseInt(planDays) + '元';
        }
    }
